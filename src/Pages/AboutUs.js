  ...
  return (
    <div className="mx-auto p-4">
      ...
      <p className=" px-5 pt-2 text-justify leading-8">
        ...
        every step of the way. Trust us to be your partner in your real estate
        journey, and let us help you discover the perfect place to call your
        own.
      </p>

      <h1 className="text-center font-bold text-3xl mt-2">Our Mission</h1>

      <p className=" px-5 pt-2 text-justify leading-8">
        Our mission is to simplify the process of renting and buying homes. We
        strive to offer a comprehensive platform where users can easily navigate
        through listings, find detailed property information, and make informed
        decisions. We believe that everyone deserves a place they can call home,
        and we are dedicated to making that journey as smooth and enjoyable as
        possible.
      </p>
      ...
      MyHome2U was founded with the vision of revolutionizing the
        ...
        stresses that come with finding a new home, and we are committed to
