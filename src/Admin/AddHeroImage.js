...
const AddHeroImage = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await api.post('/api/MyHome2U/HeroImage/AddHeroImage',formData);
        ...
        <div className="flex min-h-screen bg-black">
            ...
            <main className="flex-1 p-8 bg-white">
                <div className="overflow-x-auto">
                    <h1 className="text-3xl font-semibold text-gray-800 mb-6">Add New HeroImage</h1>
                    <form onSubmit={handleSubmit} className="space-y-4">
                   
                        <div>
                            <label className="block text-gray-700 font-medium mb-2" htmlFor="sectionImage">Hero Image</label>
                            <input
                                type="file"
                                id="sectionImage"
